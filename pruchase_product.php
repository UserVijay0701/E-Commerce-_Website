...
$qry=mysqli_query($connect,"select * from purchase_details where uname='$uname'");
?>
<!DOCTYPE html>
<html lang="zxx">
<head>
	...
	<div data-vide-bg ="video/gift-packs">
		<div class="center-container inner-container">
			<div class="w3_agile_header">
				...
				<!-- banner-text -->
			<h2 class="inner-heading-agileits-w3layouts">Purchase Products</h2>
...
<!-- contact-form-->
		<form action="#" method="post">
		  ...
		  <table width="1097" height="95" border="0" align="center">
            <tr>
            ...
            <tr>
              ...
              <td><div align="center"><?php echo $row['tot_amount'];?></div></td>
