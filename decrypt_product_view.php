...
$qry=mysql_query("select * from search_count where id=$gid");
$row=mysql_fetch_array($qry);
$encrypt=$row['encrypted'];
	...
	<div data-vide-bg ="video/gift-packs">
		<div class="center-container inner-container">
			<div class="w3_agile_header">
				...
				<!-- banner-text -->
			<h2 class="inner-heading-agileits-w3layouts">Product view</h2>
		  ...
		  <table width="510" height="115" border="0" align="center">
    		...
    		// Iterate through each character
    			...
    			return $outText;
 				...
 				$decrypt=cryp($encrypt);
			?>
            <tr>
              <th scope="row"><div align="center"><?php echo $row['uname'];?></div></th>
              <td><div align="center"><?php echo $row['product'];?></div></td>
              <td><div align="center"><?php echo $decrypt;?></div></td>
            </tr>
          </table>
		  <p>&nbsp;</p>
		  <p>&nbsp;</p>
