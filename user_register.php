...
if(isset($btn))
{
$max_qry = mysqli_query($connect,"select max(id) maxid from register");
$max_id = mysqli_fetch_array($max_qry);
$id = $max_id['maxid']+1;
$qry=mysqli_query($connect,"insert into register values('$id','$name','$contact','$email','$gender','$age','$address','$uname','$pass','$rdate')");
	...
	{
	echo "<script>alert('Not Register Datas...');</script>";
	}
}
?>
<!DOCTYPE html>
	...
	<div data-vide-bg ="video/gift-packs">
		<div class="center-container inner-container">
			<div class="w3_agile_header">
				...
				<!-- banner-text -->
			<h2 class="inner-heading-agileits-w3layouts">New Register</h2>
...
<!-- contact-form-->
		<form action="" method="post">
		  ...
		  <p>&nbsp;</p>
		  <p>&nbsp;</p>
		  <table width="454" height="387" border="0" align="center">
              <tr>
              ...
              <tr>
                ...
                <td><label>
                  <input name="gender" type="radio" value="radiobutton" required="">
                  Male 
                  <input name="gender" type="radio" value="radiobutton" required="">
                  Female
                </label></td>
