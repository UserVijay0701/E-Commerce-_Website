...
$qry=mysqli_query($connect,"select * from purchase_details");
?>
<!DOCTYPE html>
<html lang="zxx">
<head>
	...
	<div data-vide-bg ="video/gift-packs">
		<div class="center-container inner-container">
			<div class="w3_agile_header">
				...
				<!-- banner-text -->
			<h2 class="inner-heading-agileits-w3layouts">User Purchase Details</h2>
...
<!-- contact-form-->
		<form action="#" method="post">
		  ...
		  <table width="1126" height="105" border="0" align="center">
            <tr>
