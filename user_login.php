...
if(isset($btn))
{
$qry=mysqli_query($connect,"select * from register where uname='$uname' && pass='$pass'");
	...
	<div data-vide-bg ="video/gift-packs">
		<div class="center-container inner-container">
			<div class="w3_agile_header">
				...
				<!-- banner-text -->
			<h2 class="inner-heading-agileits-w3layouts">User Login</h2>
...
<!-- contact-form-->
		<form action="" method="post">
		  ...
		  <table width="317" height="138" border="0" align="center">
              <tr>
                <th scope="row"><div align="center">Username</div></th>
                <td><label>
                  <div align="center">
		  ...
		  <p>&nbsp;</p>
		  <p align="center"><a href="user_register.php">New Registration</a></p>
		  <p>&nbsp;</p>
		  <p>&nbsp;</p>
		  <p>&nbsp;</p>
		</form>
