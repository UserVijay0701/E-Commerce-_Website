...
$gid=$_REQUEST['gid'];
echo $un;
$qry=mysqli_query($connect,"select * from search_count where id='$gid'");
$row=mysqli_fetch_array($qry);
if(isset($btn))
{
$qry1=mysqli_query($connect,"select * from search_count where private_key='$private' ");
$num=mysql_num_rows($qry);
	...
	$gid=$row['id'];
	header("location:decrypt_product_view.php?gid='$gid'");
	}
	else
	{
	echo "<script>alert('Invalide private Key');</script>";
	}
}
?>
<!DOCTYPE html>
	...
	<div data-vide-bg ="video/gift-packs">
		<div class="center-container inner-container">
			<div class="w3_agile_header">
				...
				<!-- banner-text -->
			<h2 class="inner-heading-agileits-w3layouts">Decrypt Product</h2>
		...
		<form action="" method="post">
		  ...
		  <p>&nbsp;</p>
		   <table width="317" height="138" border="0" align="center">
              <tr>
                <th scope="row"><div align="center">Private Key</div></th>
                <td><label>
                  <div align="center">
                    <input name="private" type="password" id="private" required="">
                  </div>
                </label></td>
              </tr>
              <tr>
