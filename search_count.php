...
$qry=mysqli_query($connect,"select * from add_product");
?>
<!DOCTYPE html>
<html lang="zxx">
<head>
	...
	<div data-vide-bg ="video/gift-packs">
		<div class="center-container inner-container">
			<div class="w3_agile_header">
								...
								<nav class="navbar navbar-default">
									...
									<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
										<ul class="nav navbar-nav">
											<li class="home-icon"><a href="analyst_home.php"><span class="fa fa-home" aria-hidden="true"></span></a></li>
											<li><a href="search_count.php">Search count</a></li>
				...
				<!-- banner-text -->
			<h2 class="inner-heading-agileits-w3layouts">Search Count</h2>
...
<!-- contact-form-->
		<form action="" method="post">
		  ...
		  <p>&nbsp;</p>
		  <p>&nbsp;</p>
		  <table width="426" height="69" border="0" align="center">
  <tr>
    <th scope="row"><div align="center">Id</div></th>
    <td><div align="center">Search Value </div></td>
