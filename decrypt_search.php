...
$key=$_REQUEST['search'];
//echo $key;
$qry=mysqli_query($connect,"select * from  search_count  where product='$key'");
//echo "select * from  search_count  where product='$key'";
}
?>
<!DOCTYPE html>
<html lang="zxx">
	...
	<div data-vide-bg ="video/gift-packs">
		<div class="center-container inner-container">
			<div class="w3_agile_header">
				...
				<!-- banner-text -->
			<h2 class="inner-heading-agileits-w3layouts">Decrypt Search</h2>
...
<!-- contact-form-->
		<form action="" method="post">
		  ...
		  <p>&nbsp;</p>
		   ...
		   <p>&nbsp;</p>
		   <table width="690" height="83" border="0" align="center">
             <tr>
               <th scope="row"><div align="center"><strong>Username</strong></div></th>
               <td><div align="center"><strong>Product</strong></div></td>
               <td><div align="center"><strong>Pubilc Key</strong> </div></td>
               <td><div align="center"><strong>Decrypt</strong></div></td>
             </tr>
			 <?php
			 ...
			 ?>
             <tr>
               <th scope="row"><div align="center"><strong><?php echo md5($row['uname']);?></strong></div></th>
               <td><div align="center"><strong><?php echo $row['encrypted'];?></strong></div></td>
               <td><div align="center"><strong><?php echo $row['public_key'];?></strong></div></td>
               <td><div align="center"><strong><a href="decrypt_product.php?gid=<?php echo $row['id'];?>">Decrypted</a></strong></div></td>
             </tr>
			 <?php
			 }
			 ?>
